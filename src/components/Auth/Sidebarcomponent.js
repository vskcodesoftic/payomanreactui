...
export default function SideBarComponent() {
  ...
  const getBalance = () => {
    axios
      .get("https://payoman.com/api/merchant/remainingBalance", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
        ...
        <div id="mySidebar" className="sidebar">
          <div className="mb-2">
            <a
              ...
              onClick={closeNav}
            >
              <i className="fa fa-arrow-left mr-2 ml-2"></i> Dashboard
            </a>
          </div>
                  ...
                  <div className=" " id="collapsibleNavbar">
                    <ul className="navbar-nav">
                      ...
                      <li className="nav-item mt-3">
                        <Link to="/bankDetail">
                          <a className="nav-link">
                            <i className="fas fa-bank mr-3"></i> Bank Details{" "}
                            <i className="fa fa-chevron-right float-right"></i>
                          </a>
                        </Link>
                      </li>
                      ...
                      <li className="nav-item mt-3">
                        <Link to="/receivedAmounts">
                          <a className="nav-link">
                            <i className="fas fa-money mr-3"></i> Received
                            Amounts{" "}
                            <i className="fa fa-chevron-right float-right"></i>
                          </a>
                        </Link>
                      ...
                      <li className="nav-item mt-3">
                        <Link to="/privacyPolicy">
                          <a className="nav-link">
                            <i className="fas fa-lock mr-3"></i> Privacy and
                            Security{" "}
                            <i className="fa fa-chevron-right float-right"></i>
                          </a>
                        </Link>
                      ...
                      <li className="nav-item mt-3">
                        <Link to="/Support">
                          <a className="nav-link">
                            <i className="fas fa-headphones mr-3"></i> Support{" "}
                            <i className="fa fa-chevron-right float-right"></i>
                          </a>
                        </Link>
                      </li>
                      ...
                      <li className="nav-item mt-3">
                        <Link to="/">
                          <a className="nav-link" onClick={authService.logout}>
                            <i className="fas fa-user mr-3"></i> Logout{" "}
                            <i className="fa fa-chevron-right float-right"></i>
                          </a>
                        </Link>
                      </li>
                      <li className="nav-item mt-3">
                        ...
                        <p className="text-center">
                          @Copyright PayOman , Design And Develeope By{" "}
                          <span>Codesoftic Tech PVT LTD.</span>
                        </p>
                      </li>
                    </ul>
                  </div>
